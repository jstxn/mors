 ...
 */
export function detectShellProfile(options) {
 ...
 */
export function buildPathLine(binDir) {
 ...
 */
export function rcAlreadyContainsPathLine(content, binDir) {
 ...
 */
export function applyRcEdit(rcFile, binDir) {
 ...
 */
export function formatPreview(rcFile, binDir) {
    const pathLine = buildPathLine(binDir);
    return [
        '',
 ...
 */
export async function runSetupShell(options = {}) {
    ...
    if (options.autoConfirm) {
        ...
        confirmed = await promptConfirmation('Apply this change? (y/N) ', options.input ?? process.stdin, promptOutput);
    }
 ...
 */
async function promptConfirmation(prompt, input, output) {
...
//# sourceMappingURL=setup-shell.js.map