import type { AckResult, ReadResult, RelayMessageResponse, SendResult } from '../relay/client.js';
export declare const SPOOL_SCHEMA = "mors.spool.v1";
export declare const SPOOL_COMMAND_KINDS: readonly ["message", "tool_request", "tool_result", "read", "ack"];
