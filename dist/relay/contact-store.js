...
export class ContactStore {
     ...
     */
    getContactStatus(ownerAccountId, contactAccountId) {
     ...
     */
    isApprovedContact(ownerAccountId, contactAccountId) {
     ...
     */
    recordContact(ownerAccountId, contactAccountId) {
     ...
     */
    approveContact(ownerAccountId, contactAccountId) {
        let ownerContacts = this.contacts.get(ownerAccountId);
        if (!ownerContacts) {
            ownerContacts = new Map();
            this.contacts.set(ownerAccountId, ownerContacts);
     ...
     */
    listPendingContacts(ownerAccountId) {
        const ownerContacts = this.contacts.get(ownerAccountId);
        if (!ownerContacts)
            return [];
        const pending = [];
     ...
     */
    evaluatePolicy(recipientAccountId, senderAccountId) {
