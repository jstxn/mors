 ...
 */
import { isDeviceBootstrapped, loadDeviceKeys } from './device-keys.js';
 ...
 */
export function requireDeviceBootstrap(keysDir) {
 ...
 * @throws DeviceNotBootstrappedError if keys are not bootstrapped.
 */
export function assertDeviceBootstrapped(keysDir) {
    if (!isDeviceBootstrapped(keysDir)) {
        throw new DeviceNotBootstrappedError();
    }
}
