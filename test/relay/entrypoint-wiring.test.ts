 ...
 * - AccountStore is wired into production options
 */
...
describe('relay entrypoint wiring', () => {
  ...
  describe('accountStore is wired into production options', () => {
    it('returns options containing an AccountStore instance', () => {
      const opts = createProductionServerOptions();
